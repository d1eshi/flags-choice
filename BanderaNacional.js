...
const inputNota5 = document.getElementById('nota5')
const inputNota6 = document.getElementById('nota6')

// Container
const formularioN = document.querySelector('#bandera-nacional')
...
class Alumnos {
  ...
  calcPromedio(alumnos) {
    ...
    alumnos.map(alumno => {
      // console.log(alumno)
      const { nota1, nota2, nota3, nota4, nota5, nota6 } = alumno
      const values = [
        parseInt(nota1),
        parseInt(nota2),
        parseInt(nota3),
...
class UI {
  mostrarAlerta(mensaje, tipo) {
    ...
    formularioN.insertBefore(divMensaje, containerDatos)
...
function eventListeners() {
  ...
  inputNota5.addEventListener('change', leerDatos)
  inputNota6.addEventListener('change', leerDatos)

  formularioN.addEventListener('submit', nuevoAlumno)
}
